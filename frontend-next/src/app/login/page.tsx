        ...
        <div className="lg:w-[55%] p-5 sm:p-8 lg:p-10 flex flex-col justify-center">
          ...
          <div className="relative w-full">
            <GoogleLogin
              ...
              width="100%"
            />
            {/* Оверлей с переводом: при смене языка виден наш текст (каз/рус/англ), клик проходит в iframe Google */}
            <div
              className="absolute inset-0 flex items-center justify-center gap-2 rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 pointer-events-none"
              aria-hidden
            >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-md w-full shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            className="flex flex-col items-center justify-center min-h-[44px] p-6 rounded-xl border-2 border-gray-100 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-all group touch-manipulation"
          >
